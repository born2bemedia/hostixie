...
const getIncludes = (
  ...
  const raw = t.raw(`items.${key}.includes`);
    ...
    <section className="bg-[#FFF4E1] py-10">
      <div className="container flex flex-col gap-10">
        ...
        <section className="flex flex-col gap-5">
          <div className="flex items-stretch gap-5 max-md:flex-col max-md:items-start">
        ...
        <Text size="base" color="black" className="opacity-70">
          {t('disclaimer')}
        </Text>
      </div>
    </section>
