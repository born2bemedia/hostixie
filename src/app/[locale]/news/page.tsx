...
const getLatest = (t: Awaited<ReturnType<typeof getTranslations>>) => [
  {
...
const getTechNews = (t: Awaited<ReturnType<typeof getTranslations>>) => [
  {
...
const getPartnershipNews = (t: Awaited<ReturnType<typeof getTranslations>>) => [
  {
